...
def main(mytimer: func.TimerRequest) -> None:
    ...
    sqldb_server = os.environ['SQLDB_SERVER'] #env_dict['server']
    sqldb_database = os.environ['SQLDB_DATABASE'] #env_dict['database']
    sqldb_user = os.environ['SQLDB_USER'] #env_dict['user']
    sqldb_pwd = os.environ['SQLDB_PASSWORD'] #env_dict['pwd']
    driver= '{ODBC Driver 17 for SQL Server}'
    #logging.info(sqldb_database)
    #logging.info(sqldb_user)
    #logging.info(sqldb_pwd)
